...
//no, because now b and a are both equal
...
Prediction: the only thing that will change is the 3rd index of my_list
Actual: 
...
//there isn't anything wrong besides the fact that var_2 = "cat" doesn't update the global variable
...
//it will print out the inverse of whatever the user inputs, Ex: input: cat output: dog. Just take out the part where it updates the variables inside the function
